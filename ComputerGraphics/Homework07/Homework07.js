...
async function initShader() {
    ...
    gouraudShader = new Shader(gl, vertexShaderSourceGouraud, fragmentShaderSourceGouraud);
    phongShader = new Shader(gl, vertexShaderSourcePhong, fragmentShaderSourcePhong);
}
